...
function startTimer(){
    timex = setTimeout(function(){
      ...
      if(seconds <10) {
        document.getElementById("seconds").innerHTML='0'+seconds;} else {
...
let changecolor = (x) => {
    ...
    for(i=0; i<yviteliujra.length; i++){
        ...
        if(yviteliujra[i].style.backgroundColor == "rgb(250, 199, 72)" ||yviteliujra[i].style.backgroundColor == "rgb(255, 31, 9)"){
            ...
            num1 = parseInt(yviteliujrainner.slice(0,1));
            num2 = parseInt(yviteliujrainner.slice(2, yviteliujrainner.length));
